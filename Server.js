...
*/
       ...
       /* server.engine.addressSpace.addVariable({
        ...
        server.engine.addressSpace.addVariable({
            ...
            nodeId: "ns=1;s=average_load", // a string nodeID
            browseName: "AverageLoad",
            dataType: "Double",
            value: {
                get: function () {return new opcua.Variant({dataType: opcua.DataType.Double, value: load_average() });}
            }
        });*/
    }
